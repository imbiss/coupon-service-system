<?php
/***
 * The entry of API (use tonic framework)
 */
...
$config = array(
    'load' => array(
        __DIR__.'/../../vendor/peej/tonic/src/Tyrell/*.php', // load example resources
        //__DIR__.'/../vendor/peej/tonic/src/Tyrell/*.php' // load examples from composer's vendor directory
        __DIR__.'/../../vendors/Coupon/Api/Resources/*.php', // load example resources
    ),
