...
require_once (dirname(__FILE__) . "/kata_functions.php");
...
class Model {
	...
	{
		return $this->getTableName(null, true);
	}
	...
	/**
	 * 
	 * convert a currency to mysql safe float format
	 * 
	 * @param	float/string
	 * @return string
	 * @since 29.09.2010
	 */
	static public function dbCurrencySafeFormat($money)
	{
		$money_str = "";
		$money_str = str_replace(",", ".", $money);
		return $money_str;
	} 
}
